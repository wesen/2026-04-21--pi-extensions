---
Title: Playbook — Author a Prompto Plugin
Ticket: PROMPTO-SKILL-GUIDE
Status: active
Topics: [prompto, playbook, authoring, plugin]
DocType: playbooks
Intent: long-term
Summary: "Step-by-step playbook for authoring a prompto JSONL plugin (executable speaking the describe/render protocol)."
LastUpdated: 2026-07-05T00:00:00-04:00
WhatFor: "Walk an intern through creating, installing, testing, and debugging a prompto plugin."
WhenToUse: "Follow when a prompt needs computed content (live git state, ticket lists, HTTP) or logic the template dialect cannot express."
---

# Playbook — Author a Prompto Plugin

> Companion to §16 of `design/01-prompto-intern-guide.md`. This is the
