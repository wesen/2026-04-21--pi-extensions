---
Title: Playbook — Author a Prompto Template
Ticket: PROMPTO-SKILL-GUIDE
Status: active
Topics: [prompto, playbook, authoring]
DocType: playbooks
Intent: long-term
Summary: "Step-by-step playbook for authoring a prompto template (YAML frontmatter + tiny rendering dialect)."
LastUpdated: 2026-07-05T00:00:00-04:00
WhatFor: "Walk an intern through creating, testing, and iterating on a prompto template."
WhenToUse: "Follow when you need to add a new parameterized prompt that needs a generated form."
---

# Playbook — Author a Prompto Template

> Companion to §15 of `design/01-prompto-intern-guide.md`. This is the
