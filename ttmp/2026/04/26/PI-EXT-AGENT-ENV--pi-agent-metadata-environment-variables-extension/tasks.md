...
- [ ] Create extensions/agent-env env helpers with single-quote shell quoting, truncation, idempotent preamble markers, and env snapshot builder
- [ ] Create extensions/agent-env index extension handlers for session/turn/model state, bash tool_call injection, user_bash injection, status, and commands
- [ ] Add README with installation, variables, safety notes, and testing commands
